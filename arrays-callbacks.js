...
const zooAnimals = [
 ...
 const animalsnames = zooAnimals.map(item => item.animal_name.toLowerCase())
...
console.log(lowPopulationAnimals);
  ...
  */
  ...
  console.log(`total animal population ${accumulator}`)
  console.log(`adding animal population ${currentvalue.population}`)
...
console.log(greeting("Feisal", "Adan"));
